...
def plot_benchmark(benchmark_names, benchmark_titles, compute_averages, plot_title, filename):
    ...
    bit_sizes[0].append(50)
    times_averages[0].append(815.6925)
...
def main():
    ...
    benchmark_names = ["rsa_benchmark_python_qs.csv"]
    benchmark_titles = ["python"]
    plot_title = "Quadratic Sieve"
    filename = "qs_graph.png"
